...
class myinvpdg extends Component {
  ...
  componentDidMount(){
    ...
    console.log(idUser)
      axios.post(`http://localhost:3003/showinvoice`, {
          user_id: idUser
      ...
      .then(
          ...
          (ambilData) => {
              ...
              var abc = this.state.confirm_date
...
invupdate = () => {
  ...
  render() {
        ...
        if (this.state.redirectinvoice) return <Redirect to='/completeinvoicelist' />
              ...
              <div className="container" style={{marginTop: 70}}>
                <div className="row">
                  <div className="col-xs-12">
                    ...
                    <h2>INV-{this.state.inv_no}</h2> <i> Invoice Status: <b style={{color:'red'}}>{this.state.inv_stat_id}</b> </i> <h3 className="pull-right">Purchase Order # PO.{this.state.inv_no} </h3>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-xs-6">
                        <address>
                          <strong>Payment processed to:</strong><br />
